...
#' @param metricset String specifying which tree metrics to use; default is "spectR", other options are "spectrRnorm", "classic", and "nodibranch", or "ALL"; for more information on the options see Details.
